...
//        insurance = intent.getExtras().get("insurance").toString();
    ...
    public static String POST(String url, appointmentModel appointment){
        ...
        try {
            ...
            jsonObject.accumulate("levelOfpain", appointment.getLevelOfPain());
            jsonObject.accumulate("areaOfpain", appointment.getAreaOfPain());
            jsonObject.accumulate("department", appointment.getDeptSelected());
            jsonObject.accumulate("reason", appointment.getReason());
            jsonObject.accumulate("hbr", appointment.getHeart());
            jsonObject.accumulate("bp", appointment.getBlood());
            jsonObject.accumulate("tempreture", appointment.getTemp());
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            appointment.setAreaOfPain(areaOfPain);
            appointment.setDeptSelected(deptSelected);
            appointment.setHeart(heart);
            appointment.setReason(reason);
            appointment.setBlood(blood);
            appointment.setTemp(temp);
